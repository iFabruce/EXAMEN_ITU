			...
			<article id="content">
				<div class="wrap">
					...
					<section class="col-1-2"><div class="wrap-col">
						<div class="box">
							<div>
                                                            <form action="InventaireProduit" method="get">
                                                                <h2><span>Produit</span></h2>
                                                                <select type="text" name="produit" class="form-select">
                                                                    <option value=""></option>
                                                                </select>
                                                                 <h2><span>Quantite</span></h2>
                                                                <p><input type="number" class="form-control">Reste:</span></p>
                                                                <button class="btn btn-warning">Inserer</button>
                                                            </form>
						...
						<div class="box">
							<div>
                                                    ...
                                                    <p><input type="date" name="date" class="form-control">Reste:</span></p>
				...
				<div class="wrap">
					...
					<section class="col-1-2"><div class="wrap-col">
						<div class="box">
							<div>
                                                            <form action="InventaireIngredient" method="get">
                                                                <h2><span>Ingredient</span></h2>
                                                                <select type="text" name="ingredient" class="form-select">
                                                                    <option value=""></option>
                                                                </select>
                                                                 <h2><span>Quantite</span></h2>
                                                                <p><input type="number" class="form-control">Reste:</span></p>
