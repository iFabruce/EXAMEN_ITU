					...
					<section class="col-1-3"><div class="wrap-col">
						<div class="box">
							<div>
								...
								<h2 class="letter_spacing"><span>Addition</span></h2>
								<select name="table" id="" class="form-select">
									<option value=""></option>
                                                                        
								</select>
                                                                <h2 class="letter_spacing"><span>Type de paiement</span></h2>
								<select name="table" id="" class="form-select">
									<option value=""></option>
                                                                        
								</select>
								<br>
                                                                <button class="btn btn bg-light">Voir addition</button>
									...
									<tbody>
									  ...
									  <tr>
										...
										<td ></td>
                                                         ...
                                                         <button class="btn btn bg-warning">Valider</button>
